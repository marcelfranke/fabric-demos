...
# PMI synthetic sales + demand-forecast — parameters
...
# ── Static reference data (deterministic; no external calls) ──────────────
...
# ── Imports + deterministic demand kernel + pipeline definitions ──────────
...
# ── Driver — runs the whole pipeline under one guard ─────────────────────
try:
