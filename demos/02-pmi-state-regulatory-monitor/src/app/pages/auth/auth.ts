...
@Component({
  ...
  template: `
    <div class="stage">
      ...
      <main class="hero">
        <p class="eyebrow">US state regulatory monitor</p>
        <h1 class="hero__title">
          Track <em>smoke-free</em> rules,<br />
          state by state.
        </h1>
        <p class="hero__lead">
          A quiet, considered view of US state regulation across PMI's
          smoke-free product lines. Sign in to continue.
        </p>
      ...
      <footer class="meta">
        <span>© PMI Regulatory Monitor {{ year }}</span>
