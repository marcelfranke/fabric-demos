...
// to their first segment's label (e.g. /programs/abc → "Programs").
      ...
      <aside class="rail" [class.rail--collapsed]="collapsed()">
        ...
        <nav class="nav">
          ...
          <a
            ...
            routerLinkActive="active"
            class="nav__item"
            [matTooltip]="collapsed() ? 'Programs' : ''"
            matTooltipPosition="right"
          >
            <mat-icon class="nav__icon">category</mat-icon>
          ...
          <a
            ...
            routerLinkActive="active"
            class="nav__item"
            [matTooltip]="collapsed() ? 'Pricing signals' : ''"
            matTooltipPosition="right"
          >
          ...
          <div class="topbar__actions">
            @if (appConfig.isSynced()) {
              <span class="sync-badge" [matTooltip]="syncTooltip()">
                ...
                <span class="sync-badge__repo">CDC STATE System</span>
              </span>
              <button
                type="button"
                class="ghost-btn"
