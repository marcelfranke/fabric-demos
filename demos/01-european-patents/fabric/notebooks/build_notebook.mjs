// Builds the EPS ingestion .ipynb and creates it in Fabric via REST (Node.js).
import { execSync } from "node:child_process";

const TENANT = "1cf0faf3-5363-470a-8369-df15f6562c64";
const WS_ID = "5e0747bf-be6c-449b-b0cc-1911bd54577f";
const LH_ID = "adcba2df-ba38-48dd-a5b4-07dbde1a01ee";
const LH_NAME = "eps_lakehouse";
const NB_NAME = "01_ingest_eps_2026";
...
// Each cell = [sourceString, isParametersCell]
const cells = [];

cells.push([`# EPS 2026 ingestion parameters
...
cells.push([`# European Publication Server (EPS) - Medallion ingestion
...
cells.push([`# === BRONZE 1/2: weekly patent lists ===
...
cells.push([`# === BRONZE 2/2: download each patent XML, keep the SDOBI biblio block ===
...
cells.push([`# === SILVER: parse SDOBI into a normalized struct, then explode ===
from pyspark.sql.types import StructType, StructField, StringType, ArrayType
...
cells.push([`# === SILVER: write normalized tables ===
...
cells.push([`# === GOLD: analytics-ready tables for the dashboard ===
...
const tok = token();
const res = await fetch(`https://api.fabric.microsoft.com/v1/workspaces/${WS_ID}/notebooks`, {
  method: "POST",
...
if (loc) console.log("operation-location:", loc);
